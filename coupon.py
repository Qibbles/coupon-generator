...
def HTML(x):
    ...
    for i in range(len(x)):
        ...
        html.write('            <ul>\n')
        html.write('                <li>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp- Coupon redemption available at daily at:.</li>\n')
        html.write('                    <ul>\n')
        for eachTime in range(len(timeList[i])):
            html.write('                        <li>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp- ' + str(timeList[i][eachTime]) + ':00</li>\n')
        html.write('                    </ul>\n')
        html.write('                <li>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp- <b>' + str(mmq[i]) + ' MameQ</b> is required for this cart coupon.</li>\n')
        html.write('                <li>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp-  Coupon is limited to a total of <b>' + str(qty[i]) + '</b> applicants daily.</li>\n')
        html.write('            </ul>')
        html.write('            <br>\n')
    ...
    html.write('        <td><a href="http://dp.image-gmkt.com/dp2016/SG/design/PM1/2019/12/sendcoupon_MB.html" target="_blank"><img src="http://dp.image-gmkt.com/dp2016/SG/design/PM1/2019/12/buttons_03.png" width="100%"></a></td>\n')
    html.write('        <td><a href="https://dp.image-gmkt.com/dp2016/SG/design/How_to_use_coupons.jpg" target="_blank"><img src="http://dp.image-gmkt.com/dp2016/SG/design/PM1/2019/12/buttons_04.png" width="100%"></a></td>\n')
    html.write('    </tr>\n')
    html.write('</table>\n')
    html.write('<div id="tnc" class="tncModal">\n')
    html.write('    <div class="tncModalContent">\n')
